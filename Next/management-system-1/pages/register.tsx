            ...
            <div className="bg-teal-100 flex md:flex-row flex-col justify-center items-center gap-10 rounded-xl">
                ...
                className={`w-full p-4 flex flex-col gap-5`}>
                    ...
                    <div className="flex gap-5">
                        ...
                        transition-colors duration-300 rounded-xl outline-none">Register</button>
                        <Link href={"/login"} className="px-4 py-2 bg-teal-950 text-white hover:bg-teal-800
                        transition-colors duration-300 rounded-xl outline-none"><span className="hidden xl:inline">Already registered?</span> Log in here!</Link>
                    </div>
                </form>
