...
const Game8x8 = ({game}:Props) => {
  ...
  return (
    <div className="relative w-full min-h-screen h-full bg-black flex flex-col gap-5 justify-center items-center">
        ...
        <div className={`w-full max-w-5xl h-full grid grid-cols-8 grid-rows-8 md:gap-5 gap-1 p-5 items-center justify-items-center ${loading ? "pointer-events-none opacity-0" : "pointer-events-auto opacity-100"}`}>
            {
                gamemode === "standard" ?
